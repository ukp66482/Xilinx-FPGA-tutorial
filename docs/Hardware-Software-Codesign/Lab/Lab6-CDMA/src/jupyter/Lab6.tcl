...
\
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_cdma_0/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net add_0_R_req [get_bd_pins add_0/R_req] [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net add_0_W_data [get_bd_pins add_0/W_data] [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net add_0_W_req [get_bd_pins add_0/W_req] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net add_0_addr [get_bd_pins add_0/addr] [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins add_0/R_data]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins add_0/clk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins add_0/rst] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins smartconnect_0/aresetn]
